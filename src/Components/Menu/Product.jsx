...
const Product = ({ data }) => {
    ...
    return (
        <div className="h-64 space-y-3 w-64  sm:w-52 md:w-64 mb-4 sm:mb-0  p-3 shadow-sm border-[1px] hover:shadow-lg transition cursor-pointer rounded-md hover:rounded-xl ">
            <div className="flex items-center justify-center h-2/4 ">
                <img src={img} alt="" className="h-full object-cover select-none" lazyLoad="true"/>
            </div>
            ...
            <div className="flex items-center justify-between ">
                <p className="text-gray-700 font-medium text-sm">Rs:{price}</p>
                <button
